...
for j in range(gt.shape[0]):
    ...
    for i in range(pred_cut.shape[0]):
        ...
        if pred_cut[i].replace("%20"," ")==gt[j] and len(f[j])==0:
            ...
            if pred_diag[i]=='Positive':
                f[j].append(str(2))
            elif pred_diag[i]=='Suspect positive':
                f[j].append(str(1))
            else:
                f[j].append(str(0))
            f[j].append(str(int(gt_diag[j]=="CANCER")))
            if (int(pred_diag[i]=='Suspect positive')>0 or int(pred_diag[i]=='Positive')>0) and int(gt_diag[j]=="CANCER")>0:#TP
                f[j].append(str(1))
                f[j].append(str(0))
                f[j].append(str(0))
                f[j].append(str(0))
            elif (int(pred_diag[i]=='Suspect positive')>0 or int(pred_diag[i]=='Positive')>0) and int(gt_diag[j]=="CANCER")==0:#FP
                f[j].append(str(0))
                f[j].append(str(1))
                f[j].append(str(0))
                f[j].append(str(0))
                ...
                f[j].append(str(1))
                f[j].append(str(0))
            elif int(pred_diag[i]=='Suspect positive')==0 and int(gt_diag[j]=="CANCER")>0:#FN
                f[j].append(str(0))
                f[j].append(str(0))
                f[j].append(str(0))
                f[j].append(str(1))
