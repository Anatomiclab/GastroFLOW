...
ref_data = pd.read_csv("/home/htihe/Gastric_Flow_verify/Gastric_Flow/Code_Integration/801010/train_cross10.csv")
...
def read(model_path):
    ...
    data = pd.read_csv("/home/htihe/Gastric_Flow_verify/Gastric_Flow/Code_Integration/801010/test_cross10.csv")
